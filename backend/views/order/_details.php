...
?>
<div class="form aform order-details-page">
...
<div class="clear"></div>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'payment_method', CHtml::listData(PaymentMethod::model()->findAll(), function($data){return $data->getName();}, function($data){return $data->getName();})); ?>
		<?php echo $form->error($model,'payment_method'); ?>
	</div>
	<div class="row">
		<?php echo $form->labelEx($model,'shipping_method'); ?>
		<?php echo $form->dropDownList($model,'shipping_method', CHtml::listData(ShippingMethod::model()->findAll(), function($data){return $data->getName();}, function($data){return $data->getName();})); ?>
...
<a href="<?php echo $this->createUrl('order/refreshdetails') ?>" class="refresh-details-link"></a>
</div>