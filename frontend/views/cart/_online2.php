...
<?php echo CHtml::beginForm('https://stageserv.interswitchng.com/test_paydirect/pay', 'POST'); ?>
<div class="section_body_general">
	<div class="checkout_wrapper">
		

		<?php echo CHtml::image(Yii::app()->request->baseUrl.'/img/interswitch-logo.png'); ?>
		...
		<?php 
		//$hash = hash('sha512', $ref.'4903'.'101'.($total*100).UtilityHelper::yiiparam('site_redirect_url').UtilityHelper::yiiparam('MAC_key'));
		echo CHtml::hiddenField('merch_txnref',$ref);
		echo CHtml::hiddenField('merchantid','3344');
		...
		echo CHtml::hiddenField('phone_number', $order->phone);
