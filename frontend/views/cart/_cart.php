...
<div class="section_body_general">
	...
	<tr>
		...
		<td><div class="topay">&#8358;<?php echo $product['total']; ?></div><div class="topay_break"><span class="badge"><?php echo $product['quantity']; ?></span> x &#8358;<?php echo $product['price']; ?></div></td>
	...
	<div class="row-fluid">
		<div class="span5 offset7 compute">
			<div class="row-fluid">
				...
				<div class="span7 column">&#8358;<?php echo $this->getCartSubTotal();?></div>
			</div>
			<div class="row-fluid odd">
				<div class="span5 column first">Delivery</div>
				<div class="span7 column">&#8358;<?php echo $this->getDelivery();?></div>
			</div>
			<div class="row-fluid">
				<div class="span5 column first">VAT</div>
				<div class="span7 column">&#8358;<?php echo $this->getVAT();?></div>
			</div>
			<div class="row-fluid odd">
				<div class="span5 column first">Total</div>
				<div class="span7 column">&#8358;<?php echo $this->getCartTotal();?></div>
			</div>
		</div>
	</div>
	<?php } ?>
