...
<div class="checkout_head_general">
	...
	<div class="checkout_top">
		<span class="in_your_cart">In your Cart</span> <?php echo CHtml::image(Yii::app()->request->baseUrl.'/img/checkout_arrow.png'); ?> <span class="badge"><?php echo $this->getCartCount();?></span> <strong>@ &#8358;<?php echo $this->getCartTotal();?></strong> <a href="<?php echo $this->createUrl('cart/cart'); ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl.'/img/checkout_edit.png'); ?></a>
	</div>
	<div class="clear"></div>
</div>
<?php $form = $this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	'id' => 'address-form',
	'action'=>Yii::app()->createUrl('cart/checkout'),
));
?>
<div class="section_body_general">
	<div class="checkout_2_wrapper">
	<span class="new_add_title">Enter New Address</span>
	<?php if(!empty($address)){ ?>
	<?php echo CHtml::image(Yii::app()->request->baseUrl.'/img/checkout_or.png','',array('class'=>'add_or')); ?>
	<span class="old_add_title">Select your Address</span>
	<?php } ?>
	<div class="shipping_new_add">
...
<div class="section_foot_general">
	...
	<input type="submit" class="f_right_checkout2" value="" />
	<div class="clear"></div>
</div>
<?php $this->endWidget(); ?>