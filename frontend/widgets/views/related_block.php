...
<div class="related<?php if(($i+1) % 2 == 0) echo ' related_odd'; ?>">
	<div class="related_inner">
		<a href="<?php echo $link; ?>"><?php echo CHtml::image(Yii::app()->request->baseUrl . $related->image); ?>
		<span class="related_title"><?php echo $related->getName(); ?></span>					
		<span class="related_price"><?php echo $related->printPrice($related->price); ?></span></a>
	</div>
</div>
	<?php if($i==2)
		break;
